...
public class hdf5_getters
{
	...
	try {
        ...
        System.out.println("song id: " + get_song_id(h5));
	    ...
	    System.out.println("artists terms, length: "+resS.length+", ele 0:  "+resS[0]);
	    res = get_artist_terms_freq(h5);
	    System.out.println("artists terms freq, length: "+res.length+", ele 0: "+resS[0]);
